...
Tool314 is a lightweight utility for managing common Raspberry Pi system tasks  
such as fan control, DNS configuration, and basic system tweaks without manually
...
> This is an unofficial, community-developed tool and is not affiliated with the Raspberry Pi Foundation. Tool314 is primarily developed and tested on Raspberry Pi devices. Compatibility with other boards (such as Orange Pi) is not guaranteed.
